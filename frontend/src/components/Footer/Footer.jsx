      ...
      <div className="footer-content">
        <div className="footer-content-left">
            ...
            <div className="footer-social-icons">
                <img href="#" src={assets.facebook_icon} alt="" />
                <img href="https://x.com/SiddeshSapate?t=EZ4Ho7IHz_5kDVrsYYl2AA&s=09" src={assets.twitter_icon} alt="" />
                <img href="https://www.linkedin.com/in/siddesh-s12/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" src={assets.linkedin_icon} alt="" />
            </div>
        </div>
